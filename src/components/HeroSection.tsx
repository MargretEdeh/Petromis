...
export default function HeroSection() {
  return (
    <div className="w-full  relative">
      <img
        className="w-full relative  object-fill  object-center md:h-lvh h-72  "
        src={bgRectangle}
      />
      ...
      <div className=" px-5 absolute inset-0 flex flex-col items-center justify-center text-white bg-black bg-opacity-50">
        ...
        <p className="z-10 lg:w-1/3 text-center mt-5 md:mt-10">
          Leading the Way in Oil & Gas, Renewable Energy, precious stone mining,
          Metals Recycling, and Transportation
        </p>
      </div>
    </div>
  );
